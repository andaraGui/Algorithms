...
*/
const input = require('fs').readFileSync('URI_1864_stdin', 'utf8');
const letters = parseInt(input.split('\n'));

const quoteArray = Array.from('LIFE IS NOT A PROBLEM TO BE SOLVED')
let output = '';
